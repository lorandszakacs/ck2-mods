...
NDiplomacy = {
	...
	MAX_PREP_INV_TARGET_HOLDINGS = 200,			-- The target must control at the most this many holdings within the target kingdom to be a valid prepared invasion target
	MAX_PREP_INV_ATTACKER_HOLDINGS = 200,		-- The attacker must have fewer Holdings than this in the realm (disallow Prepared Invasions for rulers who are already very powerful)
...
NNomad = {
	...
	MAX_CLANS = 21,									-- The maximum amount of clans, regardless of realm size
