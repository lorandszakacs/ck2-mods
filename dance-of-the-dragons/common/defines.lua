...
NDiplomacy = {
	...
	SEND_GIFT_INCOME_SCALEFACTOR = 1, 
	...
	DEMESNE_MAX_SIZE_STEWARDSHIP_MULT = 2.15,	-- Extra Max Demesne Size from ruler and spouse intrigue
	...
	MAX_PREP_INV_TARGET_HOLDINGS = 70,			-- The target must control at the most this many holdings within the target kingdom to be a valid prepared invasion target
	MAX_PREP_INV_ATTACKER_HOLDINGS = 1000,		-- The attacker must have fewer Holdings than this in the realm (disallow Prepared Invasions for rulers who are already very powerful)
...
NCharacter = {
	...
	MAX_JOINED_FACTIONS = 0,						-- Maximum number of Factions a character can be a member of (including led factions)
	...
	NATURAL_DEATH_CHANCE_AGE_20 = 1,				-- Natural deaths per decade out of 10000 people: Age 20-29
	NATURAL_DEATH_CHANCE_AGE_30 = 1,				-- Natural deaths per decade out of 10000 people: Age 30-39
	NATURAL_DEATH_CHANCE_AGE_40 = 1,				-- Natural deaths per decade out of 10000 people: Age 40-49
