...
NDiplomacy = {
	...
	VASSAL_LIMIT_EMPEROR_MULT = 100.0, 			-- Extra Vassal Limit from the ruler's rank
	...
	MAX_PREP_INV_TARGET_HOLDINGS = 80,			-- The target must control at the most this many holdings within the target kingdom to be a valid prepared invasion target
	MAX_PREP_INV_ATTACKER_HOLDINGS = 5000,		-- The attacker must have fewer Holdings than this in the realm (disallow Prepared Invasions for rulers who are already very powerful)
